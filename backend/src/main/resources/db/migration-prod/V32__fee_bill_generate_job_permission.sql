...
ON DUPLICATE KEY UPDATE menu_name = VALUES(menu_name), permission_code = VALUES(permission_code), api_path = VALUES(api_path), sort_no = VALUES(sort_no), status = VALUES(status);

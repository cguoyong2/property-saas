...
CREATE DATABASE IF NOT EXISTS property_saas DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE property_saas;
...
CREATE TABLE member_prepayment (
...
CREATE TABLE member_prepayment_usage (
  usage_id BIGINT PRIMARY KEY,
  tenant_id BIGINT NOT NULL,
  project_id BIGINT NOT NULL,

...
const reconcileCurrentCheckStatusOptions = [
  { label: '复算已解决', value: 'RESOLVED' },
  { label: '复算仍异常', value: 'STILL_ABNORMAL' },
]
...
const billingPages: PageConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { prop: 'collectedAmount', label: '实收金额' },
      { prop: 'paidAmount', label: '账单已收' },
      { prop: 'generatedPrepaymentAmount', label: '转预存款' },
      { prop: 'generatedPrepaymentRemainingAmount', label: '预存余额' },
    ...
    detailFields: [
      ...
      { prop: 'detailSummary', label: '应收明细' },
      { prop: 'receivableAmount', label: '应收' },
      { prop: 'discountAmount', label: '优惠' },
      { prop: 'prepaymentAppliedAmount', label: '预存抵扣' },
      { prop: 'collectedAmount', label: '实收金额' },
      { prop: 'paidAmount', label: '账单已收' },
      { prop: 'generatedPrepaymentAmount', label: '转入预存款' },
      { prop: 'generatedPrepaymentRemainingAmount', label: '预存款余额' },
      { prop: 'refundAmount', label: '已退' },
      { prop: 'remainingAmount', label: '待收' },
      { prop: 'dueDate', label: '到期日' },
      { prop: 'status', label: '状态', type: 'select', options: billStatusOptions },
      { prop: 'sourceType', label: '来源' },
      { prop: 'prepaymentUsageSummary', label: '预存款使用' },
      { prop: 'voidReason', label: '作废原因' },
      { prop: 'createdAt', label: '创建时间' },
    ],
  },
  {
...
const billingExtraPages: PageConfig[] = [
  ...
  },
  {
    ...
    columns: [
      { prop: 'projectId', label: '小区名称', type: 'project' },
      { prop: 'memberName', label: '业主/住户', inFilter: true },
      { prop: 'mobile', label: '手机号', inFilter: true },
      { prop: 'houseNo', label: '房号' },
      { prop: 'orderNo', label: '来源订单', inFilter: true },
      { prop: 'billSummary', label: '来源账单明细' },
      { prop: 'amount', label: '预存金额' },
      { prop: 'usedAmount', label: '已抵扣' },
      { prop: 'refundedAmount', label: '已退款' },
  ...
  {
    key: 'payment-reconcile-reviews',
    title: '异常复核',
    group: '收费账务',
    route: '/payment/reconcile/reviews',
    icon: DataAnalysis,
    ...
    columns: [
      ...
      { prop: 'memberName', label: '业主/住户', inFilter: true },
      { prop: 'memberMobile', label: '手机号' },
      { prop: 'amount', label: '当前差异金额' },
      { prop: 'currentCheckStatus', label: '复算状态', type: 'select', options: reconcileCurrentCheckStatusOptions, inFilter: true },
      { prop: 'reviewStatus', label: '复核状态', type: 'select', options: reconcileReviewStatusOptions, inFilter: true },
      { prop: 'handleRemark', label: '处理备注' },
      { prop: 'handledAt', label: '处理时间' },
      { prop: 'reviewedAt', label: '复核时间' },
      { prop: 'reviewRemark', label: '复核备注' },
    ...
    detailFields: [
      ...
      { prop: 'memberMobile', label: '手机号' },
      { prop: 'amount', label: '当前差异金额' },
      { prop: 'reason', label: '复算说明' },
      { prop: 'currentCheckStatus', label: '复算状态', type: 'select', options: reconcileCurrentCheckStatusOptions },
      { prop: 'status', label: '处理状态', type: 'select', options: reconcileExceptionStatusOptions },
      { prop: 'handledAt', label: '处理时间' },
      { prop: 'handledBy', label: '处理人ID' },
      { prop: 'handleRemark', label: '处理备注' },
...
const servicePages: PageConfig[] = [
  ...
  },
  {
    ...
    detailFields: [
      ...
      { prop: 'channel', label: '渠道', type: 'select', options: messageChannelOptions },
      { prop: 'titleTemplate', label: '标题模板' },
      { prop: 'contentTemplate', label: '内容模板' },
      { prop: 'status', label: '状态', type: 'select', options: enabledStatusOptions },
      { prop: 'createdAt', label: '创建时间' },
    ],
    fields: [
      { prop: 'templateCode', label: '业务类型', type: 'select', options: messageTemplateCodeOptions, required: true },
